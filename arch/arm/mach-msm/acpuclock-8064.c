...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[4]  = { {  594000, HFPLL, 1, 0x16 }, 1000000, 1000000, 3 },
	[5]  = { {  648000, HFPLL, 1, 0x18 }, 1000000, 1000000, 3 },
	[6]  = { {  702000, HFPLL, 1, 0x1A }, 1100000, 1100000, 4 },
	[7]  = { {  756000, HFPLL, 1, 0x1C }, 1100000, 1100000, 4 },
	[8]  = { {  810000, HFPLL, 1, 0x1E }, 1000000, 1100000, 4 },
...
static struct acpu_level tbl_PVS5_1700MHz[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(5),   875000 },
	//{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),   925000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(14),  912500 },
	//{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(14),  950000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(14),  937500 },
...
static struct acpu_level tbl_PVS6_1700MHz[] __initdata = {
	...
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(14), 975000 },
